...
Runnable r = new Runnable() {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_send:
			final ParseObject message = createMessage();
			// send(message);
			if (message == null) {
				// error
				...
				Toast.makeText(RecipientsActivity.this,
						"Sending Message", Toast.LENGTH_LONG).show();

				final ProgressDialog ringProgressDialog = ProgressDialog.show(RecipientsActivity.this, "Please wait ...",	"Sending Message ...", true);
	...
	synchronized protected void send(final ParseObject message) {
