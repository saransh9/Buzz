...
{
    public static final Uri CONTENT_URI = Uri.parse("content://com.teamtreehouse.ribbit/recordings");
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
        case RECORDINGS: return "vnd.android.cursor.dir/vnd.teamtreehouse.ribbit";
        case RECORDING_ID: return "vnd.android.cursor.item/vnd.teamtreehouse.ribbit";
        default: throw new IllegalArgumentException("Unsupported URI: " + uri);
        }
    }
    ...
    static {
        ...
        uriMatcher.addURI("com.teamtreehouse.ribbit", "recordings", RECORDINGS);
        uriMatcher.addURI("com.teamtreehouse.ribbit", "recordings/#", RECORDING_ID);
    }
